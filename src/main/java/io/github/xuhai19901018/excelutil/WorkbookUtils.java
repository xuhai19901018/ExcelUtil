...
public class WorkbookUtils {
     ...
     * @throws Exception
     */
    public static Workbook openWorkbook(ServletContext ctx, String config) throws Exception {
     ...
     * @throws Exception
     */
    public static Workbook openWorkbook(String fileName) throws Exception {
        InputStream in = null;
        Workbook wb = null;
        try {
     ...
     * @return��Workbook
     */
    public static Workbook openWorkbook(InputStream in) throws Exception {
     ...
     * @throws Exception
     */
    public static void SaveWorkbook(Workbook wb, OutputStream out) throws Exception {
